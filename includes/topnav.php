        ...
        <div class="flex items-center">
            ...
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200">
                ...
                switch($page) {
                    ...
                    case 'goals.php': echo 'My Goals'; break;
                    case 'calendar.php': echo 'Calendar'; break;
                    case 'profile.php': echo 'Profile Settings'; break;
                    case 'add_goal.php': echo 'Add New Goal'; break;
                    case 'edit_goal.php': echo 'Edit Goal'; break;
