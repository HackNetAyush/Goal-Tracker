<div id="sidebar" class="sidebar w-64 bg-white shadow-md z-10 transition-all duration-300 dark:bg-gray-800">
    <div class="p-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-blue-600 dark:text-blue-400">GoalTrack Pro</h1>
        ...
        <div class="mt-8">
            ...
            <p class="text-center text-sm text-gray-500 dark:text-gray-400">Track your goals with ease</p>
        </div>
    </div>
    <nav class="mt-2">
        ...
        <a href="calendar.php" class="flex items-center py-3 px-6 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 border-l-4 <?php echo basename($_SERVER['PHP_SELF']) == 'calendar.php' ? 'border-blue-600 bg-blue-50 dark:bg-gray-700' : 'border-transparent'; ?> dark:text-gray-300 dark:hover:bg-gray-700">
            <i class="fas fa-calendar mr-3 <?php echo basename($_SERVER['PHP_SELF']) == 'calendar.php' ? 'text-blue-600 dark:text-blue-400' : ''; ?>"></i>
            <span>Calendar</span>
        </a>
