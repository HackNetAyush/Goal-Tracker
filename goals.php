...
$page_title = "Goals - GoalTrack Pro";
        ...
        <main class="px-6 py-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                <form method="GET" class="relative w-full md:w-64">
                    <input type="text" name="search" placeholder="Search goals..." value="<?php echo $search ? $search : ''; ?>" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <?php if(empty($goals)): ?>
                    <div class="col-span-full text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300">No goals found</h3>
                        <p class="text-gray-500 dark:text-gray-400 mt-2">Create your first goal by clicking the "Add Goal" button</p>
                    </div>
                <?php else: ?>
