...
$page_title = "Add Goal - GoalTrack Pro";
        ...
        <main class="px-6 py-8">
            <div class="max-w-3xl mx-auto">
                <div class="bg-white rounded-lg shadow-md p-6 mb-8 dark:bg-gray-800">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6 dark:text-gray-200">Add New Goal</h2>
                    ...
                    <form action="add_goal.php" method="POST">
                        <div class="mb-6">
                            <label for="title" class="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Goal Title</label>
