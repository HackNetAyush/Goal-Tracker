...
$page_title = "Dashboard - GoalTrack Pro";
        ...
        <main class="px-6 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow-md p-6 flex items-center fade-in dark:bg-gray-800">
                    ...
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Active Goals</h3>
            ...
            <!-- Recent Goals -->
            <h2 class="text-xl font-bold text-gray-800 mb-6 dark:text-gray-200">Recent Goals</h2>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-700 dark:text-gray-300">
                                ...
                                switch($activity->activity_type) {
                                    case 'goal_created':
                                        $activityText = "You created a new goal <span class='font-semibold text-green-600 dark:text-green-400'>\"{$activity->goal_title}\"</span>";
                                        break;
                                    case 'goal_updated':
